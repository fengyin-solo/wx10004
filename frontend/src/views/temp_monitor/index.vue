<template>
  <section class="page" data-module="temp_monitor">
    <header class="page-head">
      <div>
        <h2>温控监测管理</h2>
        <p class="page-desc">维护温度记录，围绕记录编号、运单编号、当前温度、温度上限做登记、筛选与状态流转。</p>
      </div>
...
const columns = ["记录编号", "运单编号", "当前温度", "温度上限", "温度下限", "记录时间", "设备编号", "记录状态"]
const actions = ["标记预警", "确认超温", "数据补录"]
const statuses = ["正常", "接近临界", "超温", "数据缺失"]
const stats = [{"label": "正常运单", "value": 0}, {"label": "预警运单", "value": 0}, {"label": "超温运单", "value": 0}]
